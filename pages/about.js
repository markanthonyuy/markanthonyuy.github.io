  ...
  const makeList = ({ list, title }) => (
    <div className={styles.box}>
      ...
      >
        {list.map((p, key) => (
          <li key={`${p.name}-${key}`}>
            <a href={p.link} rel="noopener" target="_blank">
              {p.name}
            </a>
          </li>
        ))}
    ...
    <Container>
      ...
      <div className={styles.about}>
        ...
        >
          ...
          Engineer in the BPO industry. That's where I got expose with various
          companies big companies. Like Globe and TV5 Network. I work mostly on
          front-end development because that's where I found my passion. I love
          seeing fast, creative and intuitive websites. Google lighthouse is my
          friend.
        </motion.p>
        ...
        >
          ...
          quotes is inspired by Codepen's button, Big fonts and spacious
          elements are from Smashing magazine and Design course website. I feel
          really good and proud of the outcome. It's way far from my previous
          design.
        </motion.p>
        <motion.p
          initial={{ y: 50, opacity: 0 }}
          animate={{ y: 0, opacity: 1, transition: { delay: 0.9 } }}
        >
          Here is the <a href="https://markanthonyuy.com/old">link</a> if you
          want a peek.
        </motion.p>
